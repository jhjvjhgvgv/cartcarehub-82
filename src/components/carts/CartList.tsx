      ...
      <ScrollArea className="min-h-[300px] max-h-[calc(100vh-16rem)] md:max-h-[calc(100vh-12rem)]">
        <Table>
          <TableHeader className="sticky top-0 bg-background z-10">
            <TableRow>
              <TableHead className="w-[100px] min-w-[80px] lg:w-[20%]">RFID Tag</TableHead>
              ...
              <TableHead className="hidden sm:table-cell w-[120px] min-w-[100px] lg:w-[20%]">Last Maintenance</TableHead>
              <TableHead className="w-[100px] min-w-[80px] lg:w-[15%]">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {carts.length === 0 ? (
